...
const highlight = editor => {
    ...
    const lexer = /(#.*)|(\$[\w\.\[\]]+)|\b(if|elif|else|while|endwhile|break|exit|endif)\b|\b(connect|listen|disconnect|reset|seq|send|wait|expect|loadmsg|set|incr|decr|print|sleep|assert|include|waitstatus)\b/g;
